...
MVPと、ZCode 3.3.6、3.8.1、3.9.1、および3.9.2 hostが提供するpost-MVP surfaceは実装・runtime検証済みです。
...
ZCode 3.9.2 build 3.9.2.6069 / CLI 0.16.5で次を実行済みです。
...
- 3.9.2 native `stopGeneration`、`respondElicitation`、permission option IDの往復
